...
namespace MusicApp2.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Year,Artist,Name,CoverArt")] Albums albums)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Year,Artist,Name,CoverArt")] Albums albums)
        {
            if (ModelState.IsValid)
            {
